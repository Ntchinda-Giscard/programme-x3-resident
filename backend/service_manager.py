...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        log_to_service_file("Usage:")
        log_to_service_file("  python service_manager.py install")
        log_to_service_file("  python service_manager.py uninstall")
        log_to_service_file("  python service_manager.py start")
        log_to_service_file("  python service_manager.py stop")
        log_to_service_file("  python service_manager.py status")
    ...
    try:
        if command == "install":
            ...
            log_to_service_file(f"Unknown command: {command}")
    except Exception as e:
